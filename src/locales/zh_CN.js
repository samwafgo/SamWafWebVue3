...
export default {
  ...
  menu: {
    ...
    host: {
      ...
      tamper_protection: "网站防篡改",
      tamper_protection_log: "防篡改日志",
      tamper_protection_file_hash: "防篡改文件哈希",
    },
    analysis: {
      parent_title: "数据分析",
      analysis_title: "数据分析",
  ...
  page: {
    ...
    tamper_protection: {
      alert_message: "SamWaf 本页面提示信息",
      button_add_tamper_protection: "新建",
      host_code: "网站",
      name: "名称",
      protected_path: "保护路径",
      backup_path: "备份路径",
      ...
      is_enable: "是否启用",
      remarks: "备注",
      is_baseline_completed: "基线是否完成",
      total_files: "总文件数",
      completed_files: "已完成文件数",
      baseline_scan: "基线扫描",
      view_log: "查看日志",
      view_file_hash: "查看文件哈希",
    },
    tamper_protection_log: {
      alert_message: "SamWaf 本页面提示信息",
      button_add_tamper_protection_log: "新建",
      config_id: "配置ID",
      host_code: "网站",
      file_path: "文件路径",
      action_type: "操作类型",
    ...
    tamper_protection_file_hash: {
      alert_message: "SamWaf 本页面提示信息",
      button_add_tamper_protection_file_hash: "新建",
      config_id: "配置ID",
      file_path: "文件路径",
      file_hash: "文件哈希值",
      file_size: "文件大小",
