...
//访问账号列表
export function wafAccessAccountListApi(params: Record<string, any>) {
  return request({
...
//访问账号详情
export function wafAccessAccountDetailApi(params: Record<string, any>) {
  return request({
...
//新增访问账号
export function wafAccessAccountAddApi(params: Record<string, any>) {
  return request({
...
export function wafAccessAccountEditApi(params: Record<string, any>) {
  return request({
...
//重置密码(会同时踢掉该账号所有在线会话)
export function wafAccessAccountResetPwdApi(params: Record<string, any>) {
  return request({
...
//删除访问账号
export function wafAccessAccountDelApi(params: Record<string, any>) {
  return request({
...
export function wafAccessAccountOtpInitApi(params: Record<string, any>) {
  return request({
...
//绑定二次验证
export function wafAccessAccountOtpBindApi(params: Record<string, any>) {
  return request({
...
//解绑二次验证
export function wafAccessAccountOtpUnbindApi(params: Record<string, any>) {
  return request({
...
export function wafAccessConfigSaveApi(params: Record<string, any>) {
  return request({
...
//会话列表
export function wafAccessSessionListApi(params: Record<string, any>) {
  return request({
...
//踢下线单个会话
export function wafAccessSessionKickApi(params: Record<string, any>) {
  return request({
...
//按账号批量踢下线
export function wafAccessSessionKickByAccountApi(params: Record<string, any>) {
  return request({
...
//访问认证审计日志
export function wafAccessAuditListApi(params: Record<string, any>) {
  return request({
