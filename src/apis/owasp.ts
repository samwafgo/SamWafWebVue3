...
/** 规则列表 */
export function owaspRulesListApi(params: Record<string, any>) {
  return request({
    url: '/owasp/rules',
    method: 'get',
    params,
...
/** 规则详情 */
export function owaspRuleDetailApi(params: Record<string, any>) {
  return request({
...
/** 启用 / 禁用 */
export function owaspRuleToggleApi(data: Record<string, any>) {
  return request({
...
/** 改写 */
export function owaspRuleOverrideApi(data: Record<string, any>) {
  return request({
...
/** 还原 */
export function owaspRuleResetApi(data: Record<string, any>) {
  return request({
...
/** tuning - 设置 */
export function owaspTuningSetApi(data: Record<string, any>) {
  return request({
    url: '/owasp/tuning',
    method: 'post',
    data,
...
/** 文件内容 */
export function owaspFileContentApi(params: Record<string, any>) {
  return request({
...
/** 沙盒测试 */
export function owaspDryRunApi(data: Record<string, any>) {
  return request({
