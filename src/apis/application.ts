...
function dangerousReq(config: Record<string, any>) {
...
// --- 普通 API ---
export function wafAppListApi(params: Record<string, any>) {
  return request({ url: '/application/app/list', method: 'post', data: params });
}
export function wafAppDetailApi(params: Record<string, any>) {
  return request({ url: '/application/app/detail', method: 'get', params });
}
export function wafAppStatusApi(params: Record<string, any>) {
  return request({ url: '/application/app/status', method: 'get', params });
}
export function wafAppLogsApi(params: Record<string, any>) {
  return request({ url: '/application/app/logs', method: 'get', params });
}
export function wafAppClearLogsApi(params: Record<string, any>) {
  return request({ url: '/application/app/clearlogs', method: 'post', data: params });
}
export function wafAppBackupsApi(params: Record<string, any>) {
  return request({ url: '/application/app/backups', method: 'get', params });
}
export function wafAppNetStatsApi(params: Record<string, any>) {
  return request({ url: '/application/app/network', method: 'get', params });
}
export function wafAppChangeLogsApi(params: Record<string, any>) {
 ...
 */
export function buildUploadConfig(url: string, data: any, timeout: number, opPwd?: string): Record<string, any> {
...
export function buildRollbackConfig(params: Record<string, any>, opPwd?: string): Record<string, any> {
  const pwd = opPwd || getAppOpPassword();
  const headers: Record<string, string> = pwd ? { 'X-App-Op-Password': pwd } : {};
